...
class AppStyling {
  static TextStyle w700size22 = TextStyle(fontWeight: FontWeight.w700, fontSize: 22.sp, color: Color(AppColors.fontBlack));
  static TextStyle w700size16 = TextStyle(fontWeight: FontWeight.w700, fontSize: 16.sp, color: Color(AppColors.fontBlack));
  static TextStyle w700size12 = TextStyle(fontWeight: FontWeight.w700, fontSize: 12.sp, color: Color(AppColors.fontBlack));

  static TextStyle w600size32 = TextStyle(fontWeight: FontWeight.w600, fontSize: 32.sp, color: Color(AppColors.fontBlack));
  ...
  static TextStyle w400size16 = TextStyle(fontWeight: FontWeight.w400, fontSize: 16.sp, color: Color(AppColors.fontBlack));
}
